using PracticalTasks.EventHandlings;
...
namespace PracticalTasks
{
    public class MenuOptions
    {
        ...
        public void FilterList()
        {
            ...
            {
                throw new GetAutoByParameterException($"Cannot filter vehicle list: {exception.Message}");
            }    
        }
        ...
        public void CreateNewVehicle()
        {
            ...
            if (response == "y")
            {
                ...
                {
                    throw new InitializationException($"Error initializating new vehicle: {exception.Message}");
                }
                ...
                {
                    throw new AddException($"Error adding new vehicle: {exception.Message}");
                }                
        ...
        public void UpdateVehicle()
        {
            ...
            {
                throw new UpdateAutoException($"Cannot update vehicle: {exception.Message}");
            }
        }
        ...
        public void RemoveVehicle()
        {
            ...
            {
                throw new RemoveAutoException($"Cannot remove vehicle: {exception.Message}");
            }
        }
